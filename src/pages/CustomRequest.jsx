...
const CustomRequest = () => {
    ...
    if (isSubmitted) {
        return (
            <div className="pt-32 pb-24 min-h-screen bg-slate-900 flex items-center justify-center">
                <div className="glass-panel p-12 text-center max-w-xl mx-auto border-t-4 border-t-teal-500">
                    <div className="w-20 h-20 bg-teal-500/20 rounded-full flex items-center justify-center mx-auto mb-6 text-teal-400">
        ...
        <div className="pt-32 pb-16 min-h-screen bg-slate-900">
            <div className="bg-slate-800/50 border-b border-glass-border py-12 mb-12">
                <div className="container mx-auto px-8 max-w-6xl text-center lg:text-left flex flex-col lg:flex-row items-center justify-between gap-8">
                    ...
                    <div className="shrink-0 flex items-center gap-4 bg-slate-900/50 p-4 border border-slate-700 rounded-xl">
                        <div className="text-left">
                            <div className="text-xs text-slate-400 uppercase tracking-widest font-semibold mb-1">Guaranteed</div>
                            <div className="text-sm font-bold text-primary flex items-center gap-2">
                                <ShieldCheck size={16} className="text-teal-400" /> HIPAA Compliant
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="container mx-auto px-8 max-w-6xl">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-4 space-y-8">
                        <div className="glass-panel p-8 sticky top-28 border-teal-500/20">
                            ...
                            <ul className="space-y-8 relative z-10">
                                ...
                                <li className="flex gap-4">
                                    <div className="w-8 h-8 rounded-full bg-slate-800 border-2 border-teal-500 flex items-center justify-center shrink-0 font-bold text-sm text-teal-400">2</div>
                                    <div>
                    ...
                    <div className="lg:col-span-8">
                        <div className="glass-panel p-8 sm:p-12">
                            <form className="space-y-12" onSubmit={(e) => { e.preventDefault(); setIsSubmitted(true); }}>
                                ...
                                <div>
                                    <div className="flex items-center gap-3 mb-6 pb-2 border-b border-glass-border">
                                        <span className="flex items-center justify-center w-8 h-8 rounded bg-teal-500/20 text-teal-400 font-bold">2</span>
                                    ...
                                    <div className="space-y-6">
                                        <div>
                                            ...
                                            <select required className="w-full bg-slate-800/50 border border-slate-700 rounded-lg px-4 py-3.5 text-primary focus:border-teal-500 focus:ring-1 focus:ring-teal-500 outline-none appearance-none shadow-inner">
                                        ...
                                        <div>
                                            ...
                                            <input type="text" className="w-full bg-slate-800/50 border border-slate-700 rounded-lg px-4 py-3.5 text-primary focus:border-teal-500 focus:ring-1 focus:ring-teal-500 outline-none transition-all shadow-inner" placeholder="e.g., E11 (Type 2 Diabetes), Sepsis cohort" />
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <textarea required rows="6" className="w-full bg-slate-800/50 border border-slate-700 rounded-lg px-4 py-3.5 text-primary focus:border-teal-500 focus:ring-1 focus:ring-teal-500 outline-none resize-none transition-all shadow-inner" placeholder="We are building an ML model to predict..."></textarea>
                                        </div>

                                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                            <div>
                                                <label className="block text-sm font-semibold text-slate-300 mb-2">Target Record Volume</label>
                                                <select className="w-full bg-slate-800/50 border border-slate-700 rounded-lg px-4 py-3.5 text-primary focus:border-teal-500 focus:ring-1 focus:ring-teal-500 outline-none appearance-none shadow-inner">
                                ...
                                <div>
                                    ...
                                    <div className="border border-dashed border-slate-600 rounded-xl p-10 text-center bg-slate-900/40 hover:bg-slate-800/80 transition-all cursor-pointer group">
